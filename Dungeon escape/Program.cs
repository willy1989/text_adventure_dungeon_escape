    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("");
            Console.WriteLine("Welcome! Escape dungeon is a short text adventure game. The goal is to find you're way out of a maze.");
            Console.WriteLine("To interact with the environment, you have to use commands, following this format:'verb' thing'.");
